...
* properly cast calculations in all sub-expressions by [@zachdaniel](https://github.com/zachdaniel)
...
* support starts/ends_with by [@zachdaniel](https://github.com/zachdaniel)

## [v0.6.2](https://github.com/ash-project/ash_sql/compare/v0.6.1...v0.6.2) (2026-05-01)
...
## [v0.6.1](https://github.com/ash-project/ash_sql/compare/v0.6.0...v0.6.1) (2026-04-13)
...
* use binding instead of 0 in add_aggregates (#226) by StephanH90 [(#226)](https://github.com/ash-project/ash_sql/pull/226)
...
* only set sub_expr for literal values by [@zachdaniel](https://github.com/zachdaniel)
...
* properly increment aggregate bindings across joins by [@zachdaniel](https://github.com/zachdaniel)
